...
<head>
	...
	<meta charset="UTF-8">
	<meta name="description" content="wallstreet Landing Page Template">
	<meta name="keywords" content="wallstreet, unica, creative, html">
			...
			<div class="row">
				<div class="col-md-6 hero-text">
					...
					<form class="hero-subscribe-from">
						<button class="site-btn sb-gradients">Download</button>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 offset-lg-6 about-text">
					<h2>About Us</h2>
					<h5>Wall Street community is a decentralized community network based on the DOGECOIN blockchain. and also Wall Street:</h5>
					<ul class="list-about">
                                    <li>Not Ponzi</li>
                                    <li>Not ROI</li>
