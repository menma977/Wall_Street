              ...
              <li>
                <a href="#" id="caret-{{ $item->down_line }}" class="fa fa-plus-circle" onclick="addCaret('{{ $item->down_line }}')" style="min-width: 200px">
                  @if ($item->userDownLine)
                    ...
                    <span class="text-dark" style="font-size: 10px;"> | Turnover : {{ $item->userDownLine->profit }}</span>
                  @endif
                </a>
          ...
          responseData.forEach(element => {
            if (element.active === 1) {
              ...
              let user = '<li>' +
                ...
                + '<span class="text-dark" style="font-size: 10px;"> | Turnover : ' + element.userDownLine.profit + '</span>'
